...
fs.promises.writeFile (filePath, "this is the initial data of promies", "utf-8")
...
// fs.promises
//   .unlink(path.join(__dirname, "fspromises-renamed.txt"))
...
// fs.promises.rename(filePath, "fspromises-renamed.txt", "utf-8")
